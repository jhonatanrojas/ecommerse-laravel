<template>
  <article class="group overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div class="relative aspect-square overflow-hidden bg-gray-100">
        ...
        <div v-else class="flex h-full items-center justify-center text-gray-300">
          <svg class="h-14 w-14" viewBox="0 0 24 24" fill="currentColor">
            <path d="M19 5H5a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Zm0 12H5V7h14v10ZM8.5 11A1.5 1.5 0 1 0 8.5 8a1.5 1.5 0 0 0 0 3Zm-2.5 5h12l-3.75-5-3 4-2.25-3L6 16Z"/>
          </svg>
        </div>
    ...
    <div class="space-y-3 p-4">
      <p v-if="product.category?.name" class="text-xs font-medium uppercase tracking-wide text-indigo-600">
