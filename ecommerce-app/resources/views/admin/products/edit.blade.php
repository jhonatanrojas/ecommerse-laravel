...
<div class="mb-4">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Editar Producto</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Modifica los datos del producto "{{ $product->name }}"</p>
</div>
...
<div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg p-6">
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        @include('admin.products._form', ['submitButtonText' => 'Actualizar Producto'])
    </form>
</div>
@endsection
